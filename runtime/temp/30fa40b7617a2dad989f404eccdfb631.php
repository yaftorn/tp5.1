<?php /*a:2:{s:58:"D:\wamp64\www\tp5\app\admin\view\goods\goods_category.html";i:1571377860;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571803050;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container" id="container">
    <div class="container-wrap">
        <div class="home-panel">
            <div class="form-flex">
                <a  href="<?php echo url('goods/addCategory'); ?>" class="blue-btn">添加分类</a>
            </div>
        </div>
...
<script>
    layui.use(['table', 'treetable'], function () {
        ...
        treetable.render({
            elem: '#munu-table',// 必须
            url: "<?php echo url('goods/apiGoodsCategory'); ?>",
    ...
    function editNav(id){
        window.location.href="<?php echo url('goods/editCategory'); ?>?category_id="+id;
    }
    function delNav(id){
        $.ajax({
            url:"<?php echo url('goods/delCategory'); ?>",
            type:"get",
            data:{category_id:id},
            success:function (re) {
                if (re.code == 15){
