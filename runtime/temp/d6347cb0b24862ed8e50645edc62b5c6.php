<?php /*a:2:{s:53:"D:\wamp64\www\tp5\app\admin\view\auth\admin_list.html";i:1569058055;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571815470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="form-flex">
                <div class="order-form layui-form">
                    <div class="order-item">
                         <div class="order-box">
                              <label class="label" for="">管理员：</label>
                              <div class="order">
                ...
                <a  href="<?php echo url('auth/addAdmin'); ?>" class="blue-btn">添加管理员</a>
            </div>
        </div>
...
<script>
    layui.use(['table','form'],function (data) {
        ...
        table.render({
            ...
            ,method:"post"
            ,id:"reload"
            ,url: "<?php echo url('auth/apiAdminList'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'admin_id', title: 'ID',  fixed: 'left'}
                ,{field: 'admin_account', title: '管理员账号'}
                ,{field: 'admin_endtime', title: '最近登录时间'}
                ,{field: 'admin_ip', title: '最近登录ip'}
        ...
        table.on('tool(table)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(obj.event === 'edit'){
                window.location.href="<?php echo url('auth/editAdmin'); ?>?admin_id="+data.admin_id;
            } else if(obj.event === 'delete'){
                layer.confirm('确定要删除吗?删除后不可恢复', function(index){
                    $.ajax({
                        url:"<?php echo url('auth/delAdmin'); ?>",
                        type:"get",
