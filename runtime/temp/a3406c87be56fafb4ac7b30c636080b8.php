<?php /*a:2:{s:54:"D:\wamp64\www\tp5\app\admin\view\slider\type_list.html";i:1571304800;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571815470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container" id="container">
    <div class="container-wrap">
        <div class="home-panel">
            <div class="form-flex">
                <a  href="<?php echo url('slider/addType'); ?>" class="blue-btn">添加位置</a>
            </div>
        </div>
...
<script>
    layui.use(['table','form'],function (data) {
        ...
        table.render({
            ...
            ,method:"post"
            ,id:"reload"
            ,url: "<?php echo url('slider/apiTypeList'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'type_id', title: 'ID',  fixed: 'left'}
                ,{field: 'type_name', title: '位置名称'}
        ...
        table.on('tool(table)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(obj.event === 'edit'){
                window.location.href="<?php echo url('slider/editType'); ?>?type_id="+data.type_id;
            } else if(obj.event === 'delete'){
                layer.confirm('确定要删除吗?删除后不可恢复', function(index){
                    $.ajax({
                        url:"<?php echo url('slider/delType'); ?>",
                        type:"get",
