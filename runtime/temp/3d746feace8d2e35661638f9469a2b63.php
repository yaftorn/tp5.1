<?php /*a:2:{s:58:"D:\wamp64\www\tp5\app\admin\view\article\article_list.html";i:1571308357;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571815470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container-wrap">
        <div class="home-panel">
            <div class="form-flex">
                ...
                <a href="<?php echo url('article/addArticle'); ?>" class="blue-btn">添加文章</a>
            </div>
        </div>
...
<script>
    layui.use(['table','form'],function (data) {
        ...
        table.render({
            ...
            ,method:"post"
            ,id:"reload"
            ,url: "<?php echo url('article/apiArticleList'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
        ...
        table.on('tool(table)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(obj.event === 'edit'){
                ...
                layer.confirm('确定要删除吗?删除后不可恢复', function(index){
                    $.ajax({
                        url:"<?php echo url('article/delArticle'); ?>",
                        type:"get",
