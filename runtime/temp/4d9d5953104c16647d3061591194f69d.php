<?php /*a:2:{s:53:"D:\wamp64\www\tp5\app\admin\view\goods\goods_key.html";i:1571392468;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571803050;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container" id="container">
    <div class="container-wrap">
        <div class="home-panel">
            <div class="form-flex">
                <a  href="<?php echo url('goods/addKey'); ?>" class="blue-btn">添加属性</a>
            </div>
        </div>
...
<script>
    layui.use(['table','form'],function (data) {
        ...
        table.render({
            ...
            ,method:"post"
            ,id:"reload"
            ,url: "<?php echo url('goods/apiGoodsKey'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
        ...
        table.on('tool(table)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(obj.event === 'edit'){
                window.location.href="<?php echo url('goods/editKey'); ?>?key_id="+data.key_id;
