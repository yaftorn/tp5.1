<?php /*a:2:{s:59:"D:\wamp64\www\tp5\app\admin\view\article\category_list.html";i:1569726731;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571815470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container" id="container">
    <div class="container-wrap">
        <div class="home-panel">
            <div class="form-flex">
                <a  href="<?php echo url('article/addCategory'); ?>" class="blue-btn">添加分类</a>
            </div>
        </div>
...
<script>
    layui.use(['table', 'treetable'], function () {
        ...
        treetable.render({
            elem: '#munu-table',// 必须
            url: "<?php echo url('article/apiCategoryList'); ?>",
    ...
    function editNav(id){
        window.location.href="<?php echo url('article/editCategory'); ?>?category_id="+id;
    }
    function delNav(id){
        $.ajax({
            url:"<?php echo url('article/delCategory'); ?>",
            type:"get",
            data:{category_id:id},
            success:function (re) {
                if (re.code == 15){
