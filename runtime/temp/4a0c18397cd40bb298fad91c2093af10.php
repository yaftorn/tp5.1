<?php /*a:2:{s:56:"D:\wamp64\www\tp5\app\admin\view\member\member_list.html";i:1571801776;s:42:"D:\wamp64\www\tp5\app\admin\view\base.html";i:1571815470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table','form'],function (data) {
        ...
        table.render({
            ...
            ,method:"post"
            ,id:"reload"
            ,url: "<?php echo url('member/apiMemberList'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
        ...
        table.on('tool(table)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(obj.event === 'info'){
                window.location.href="<?php echo url('member/memberInfo'); ?>?member_id="+data.member_id;
            } else if(obj.event === 'delete'){
                layer.confirm('确定要删除吗?删除后不可恢复', function(index){
                    $.ajax({
                        url:"<?php echo url('member/delMember'); ?>",
                        type:"get",
